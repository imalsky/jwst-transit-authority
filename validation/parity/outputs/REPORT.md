...
## Measured (32 unsaturated rows)

| quantity | measured | gate |
|---|---|---|
| wavelength-grid pixels matched | 99.6% (worst row) | >= 99% at rtol 1e-09 |
